...
//           className="rounded-full mb-4"
//         />
//         <h2 className="text-lg lg:text-xl font-semibold text-gray-800 text-center">{user.name?user.name:"john"}</h2>
//         <p className="text-gray-500 text-sm lg:text-base text-center">Antique Enthusiast</p>
//         <p className="text-gray-500 text-sm lg:text-base mt-1 text-center">{user.email?user.email:"john@gmail.com"}</p>
//         <div className="mt-4 w-full max-w-xs">
//           <button className="w-full bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700 transition">
//             Edit Profile
//           </button>
